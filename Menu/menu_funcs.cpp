...
void lab5()
{
	...
	cout << "Условие задачи: вывести на экран все элементы массива, удовлетворяющие битовой маске" << endl;
	cout << "Сгенерированный массив: " << endl;
	for (int i = 0;i < 20;i++) {
		arr[i] = l + rand() % (r - l + 1);
		cout << arr[i] << " ";
	}
	cout << endl << "Введите маску" << endl;

	cin >> mask;
	cout << "Элементы массива, удовлетворющие условию: " << endl;
...
int menu2() {
	while (true) {
		system("cls"); // очистка экрана
		cout << "Выберите лабораторную работу:" << endl;
		cout << "1) Задание 5. Битовая маска" << endl;
		cout << "0) Выход в главное меню" << endl;
		int i;
		cin >> i;
		system("cls");
