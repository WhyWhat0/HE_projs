...
void lab3_2()
{
	...
	cout << "\nВведите данные массива  в виде целых чисел: " << endl;
	sum = 0;
	for (i = 0;i < 12;i++) {
...
void lab4()
{
	...
	cout << "Циклический алагоритм обработки матрицы\n(Если произведение элементов столбца меньше или равно 0, то такой столбец заполняется нулями) " << endl;
